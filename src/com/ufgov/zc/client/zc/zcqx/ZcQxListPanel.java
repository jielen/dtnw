 ...
 *
 */
public class ZcQxListPanel extends AbstractEditListBill implements ParentWindowAware {

  public static final Logger logger = Logger.getLogger(ZcQxListPanel.class);

  private ZcQxListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "ZC_EB_QX";

  private RequestMeta requestMeta = WorkEnv.getInstance().getRequestMeta();

  private ElementConditionDto elementConditionDto = new ElementConditionDto();

  private IZcQxServiceDelegate zcQxServiceDelegate = (IZcQxServiceDelegate) ServiceFactory.create(IZcQxServiceDelegate.class,
...
public ZcQxListPanel(){
  ...
  UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
    ...
    public List<SearchCondition> execute() throws Exception {
      ...
      .getCurrUserId(), ZcSettingConstants.TAB_ID_ZC_EB_QX);
...
private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
  ...
  return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcSettingConstants.TAB_ID_ZC_EB_QX), showingDisplays,
...
private final class DataDisplay extends MultiDataDisplay {
  ...
  boolean showConditionArea) {
    ...
    super(displays, showingDisplays, conditionArea, showConditionArea, ZcSettingConstants.TAB_ID_ZC_EB_QX);
      ...
      table.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
            ...
            new ZcQxDialog(self, viewList, row, tabStatus);
  ...
  protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
      ...
      public TableModel execute() throws Exception {
        ...
        return ZcQxToTableModelConverter.convertToTableModel(self.zcQxServiceDelegate.getQxLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcQxListPanel bill = new ZcQxListPanel();
...
//    toolBar.add(traceDataButton);
    ...
    if (num == JOptionPane.YES_OPTION) {
      ...
      try {
        ...
        for (int i = 0; i < beanList.size(); i++) {
          ...
          ZcQx make = (ZcQx) beanList.get(i);

          make.setStatus("cancel");

          zcQxServiceDelegate.cancelFn(make, requestMeta);
  ...
  public void doUnAudit() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQxServiceDelegate.unAuditFN(make, requestMeta);
  ...
  public void doUnTread() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQxServiceDelegate.untreadFN(make, requestMeta);
  ...
  public void doSuggestPass() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQxServiceDelegate.auditFN(make, requestMeta);
  ...
  private void executeAudit(List beanList, int isGoonAudit) {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        ZcQx report = (ZcQx) beanList.get(i);
        ...
        zcQxServiceDelegate.updateFN(report, requestMeta);

      }

      zcQxServiceDelegate.commitFN(beanList, requestMeta);
  ...
  private void doAdd() {
    ...
    new ZcQxDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doDelete() {
    ...
    try {
      ...
      for (Iterator iterator = beanList.iterator(); iterator.hasNext();) {
        ...
        ZcQxqb = (ZcQx) iterator.next();

        if (!"0".equals(ZcQxqb.getStatus())){

          JOptionPane.showMessageDialog(this, "非编辑状态单据，不可以删除！", "提示", JOptionPane.ERROR_MESSAGE);
          return;
        }

        zcQxServiceDelegate.deleteListFN(beanList, this.requestMeta);
