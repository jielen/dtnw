...
public class ZcEbBulletinChangeListPanel extends AbstractEditListBill implements ParentWindowAware {

  private String compoId = "ZC_EB_BULLETIN_CHG";
  

  private static final Logger logger = Logger.getLogger(AbstractZcEbBulletinBaseListPanel.class);

  private final ZcEbBulletinChangeListPanel self = this;

  private Window parentWindow;

  protected String title = LangTransMeta.translate("ZC_EB_BULLETIN_CHG");
  ...
  public ZcEbBulletinChangeListPanel() {
    init();
  }
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcEbBulletinChangeDialog(self,  beanList, row, tabStatus);
            }
...
//    toolBar.add(traceDataButton);
  ...
  protected void doAdd(){
    ...
    new ZcEbBulletinChangeDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  public static void main(String[] args) throws Exception {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbBulletinChangeListPanel bill = new ZcEbBulletinChangeListPanel();
