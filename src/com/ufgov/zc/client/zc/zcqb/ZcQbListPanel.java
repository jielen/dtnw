...
public class ZcQbListPanel extends AbstractEditListBill implements ParentWindowAware {

  public static final Logger logger = Logger.getLogger(ZcQbListPanel.class);

  private ZcQbListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "ZC_EB_QB";

  private RequestMeta requestMeta = WorkEnv.getInstance().getRequestMeta();

  private ElementConditionDto elementConditionDto = new ElementConditionDto();

  private IZcQbServiceDelegate zcQbServiceDelegate = (IZcQbServiceDelegate) ServiceFactory.create(IZcQbServiceDelegate.class,
...
public ZcQbListPanel(){
  ...
  UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
    ...
    public List<SearchCondition> execute() throws Exception {
      ...
      .getCurrUserId(), ZcSettingConstants.TAB_ID_ZC_EB_QB);
...
private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
  ...
  return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcSettingConstants.TAB_ID_ZC_EB_QB), showingDisplays,
...
private final class DataDisplay extends MultiDataDisplay {
  ...
  boolean showConditionArea) {
    ...
    super(displays, showingDisplays, conditionArea, showConditionArea, ZcSettingConstants.TAB_ID_ZC_EB_QB);
      ...
      table.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
            ...
            new ZcQbDialog(self, viewList, row, tabStatus);
  ...
  protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
      ...
      public TableModel execute() throws Exception {
        ...
        return ZcQbToTableModelConverter.convertToTableModel(self.zcQbServiceDelegate.getQbLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcQbListPanel bill = new ZcQbListPanel();
...
//    toolBar.add(traceDataButton);
    ...
    if (num == JOptionPane.YES_OPTION) {
      ...
      try {
        ...
        for (int i = 0; i < beanList.size(); i++) {
          ...
          ZcQb make = (ZcQb) beanList.get(i);

          make.setStatus("cancel");

          zcQbServiceDelegate.cancelFn(make, requestMeta);
  ...
  public void doUnAudit() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQbServiceDelegate.unAuditFN(make, requestMeta);
  ...
  public void doUnTread() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQbServiceDelegate.untreadFN(make, requestMeta);
  ...
  public void doSuggestPass() {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        zcQbServiceDelegate.auditFN(qb, requestMeta);
  ...
  private void executeAudit(List beanList, int isGoonAudit) {
    ...
    try {
      ...
      for (int i = 0; i < beanList.size(); i++) {
        ...
        ZcQb report = (ZcQb) beanList.get(i);
        ...
        zcQbServiceDelegate.updateFN(report, requestMeta);

      }

      zcQbServiceDelegate.commitFN(beanList, requestMeta);
  ...
  public List getCheckedList() {
    ...
    List<ZcQb> beanList = new ArrayList<ZcQb>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      ZcQb bean = (ZcQb) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new ZcQbDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doDelete() {
    ...
    try {
      ...
      for (Iterator iterator = beanList.iterator(); iterator.hasNext();) {
        ...
        ZcQbqb = (ZcQb) iterator.next();

        if (!"0".equals(ZcQbqb.getStatus())){

          JOptionPane.showMessageDialog(this, "非编辑状态单据，不可以删除！", "提示", JOptionPane.ERROR_MESSAGE);
          return;
        }

        zcQbServiceDelegate.deleteListFN(beanList, this.requestMeta);
  ...
  private void doTraceDataButton() {
    ...
    ZcQb sh = (ZcQb) beanList.get(0);

    DataFlowConsoleCanvas dfc = new DataFlowConsoleCanvas(sh.getQbCode(), this.compoId);
