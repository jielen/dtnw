...
import com.ufgov.zc.client.common.*;
...
/**
 * @ClassName: ZcEbProjectListPanel_dt
 * @Description: 项目立项
...
public class ZcEbProjectListPanel_dt extends AbstractEditListBill implements ParentWindowAware {
  private static final Logger logger = Logger.getLogger(ZcEbProjectListPanel_dt.class);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcEbProjectEditFrame_dt(ZcEbProjectListPanel_dt.this, viewList, row, tabStatus);
            }
          }
        });
      }
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return ZcEbProjectToTableModelConverter.convertToTableModel(ZcEbProjectListPanel_dt.this.zcEbProjectServiceDelegate.getZcEbProj(
   ...
   * 构造函数
   */
  public ZcEbProjectListPanel_dt() {
...
//    toolBar.add(traceDataButton);
  ...
  private void doAdd() {
    new ZcEbProjectEditFrame_dt(ZcEbProjectListPanel_dt.this, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  }
  ...
  private void doSend() {
    ...
    try {
      for (int i = 0; i < beanList.size(); i++) {
        ...
        if (toCheckZbFileAndEvalElements(proj)) {
          continue;
        }
        proj.setAuditorId(WorkEnv.getInstance().getCurrUserId());
  ...
  public static void main(String[] args) throws Exception {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        ZcEbProjectListPanel_dt bill = new ZcEbProjectListPanel_dt();
