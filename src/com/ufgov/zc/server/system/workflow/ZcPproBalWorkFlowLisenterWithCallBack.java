 ...
 *
 */
public class ZcPproBalWorkFlowLisenterWithCallBack extends ZcPproBalWorkFlowLisenter {
  ...
  public void beforeCallback(WorkflowContext context) throws WorkflowException {
    ...
    dto.setExtField1(ht.getZcBalId());
    ...
    if(zcEbBaseServiceDao.queryObject("DataExchange.getDataExchangeRedo", dto)==null){
      throw new WorkflowException("资金支付申请:"+ht.getZcHtName()+"("+ht.getZcBalId()+"),已经导出进行审批，不能收回.");
    }
  }
}
